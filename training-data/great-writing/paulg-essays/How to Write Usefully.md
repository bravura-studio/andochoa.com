...
I'm not saying no mistake gets through. For example, I added condition (c) in ["A Way to Detect Bias"](https://www.paulgraham.com/bias.html) after readers pointed out that I'd omitted it. But in practice you can catch nearly all of them.  
