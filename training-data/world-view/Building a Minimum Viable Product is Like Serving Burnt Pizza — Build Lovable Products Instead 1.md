---
title: "Building a Minimum Viable Product is Like Serving Burnt Pizza — Build Lovable Products Instead"
source: "https://review.firstround.com/dont-serve-burnt-pizza-and-other-lessons-in-building-minimum-lovable-products/"
author:
  - "[[First Round Staff]]"
published: 2019-10-21
created: 2025-11-03
description: "Product builders should aim for lovable, not just viable. Jiaona Zhang (product leader at Dropbox, Airbnb, WeWork and lecturer at Stanford) shares her tactics for building MLPs that win users' hearts."
tags:
  - "world-view"
---
...
![Don’t Serve Burnt Pizza (And Other Lessons in Building Minimum Lovable Products)](https://review.firstround.com/content/images/size/w320/format/webp/2056/firstround/zr1byrhutwcp7eruf3xq_jz-20hero-20extra-20cropped.jpg)

Don’t Serve Burnt Pizza (And Other Lessons in Building Minimum Lovable Products)

*Jiaona Zhang is currently the VP of Product at Webflow.*

If love is in the little things, then [**Jiaona “JZ” Zhang**](https://www.linkedin.com/in/jiaona/?ref=review.firstround.com) has a keen eye for the details that make users fall head over heels.

From her first PM role at [Pocket Gems](https://pocketgems.com/?ref=review.firstround.com), where she crafted mobile gaming features that kept players logging in for more, to her time at [Dropbox](https://www.dropbox.com/?ref=review.firstround.com), where her instinct for zooming in on user problems led to the creation of some of the company’s standout UI interactions, Zhang’s built an impressive career centered on spotting just the right touch that captivates and inspires users.

She’s also brought her expertise to bear on pixels *and* physical spaces, at both [Airbnb](https://www.airbnb.com/?ref=review.firstround.com) — where she served as the product lead for the [Plus launch](https://www.theverge.com/2018/2/22/17040684/airbnb-plus-hotels-standard-amenities-service-loyalty-program?ref=review.firstround.com) and Head of Product for the Homes Platform team — and now at [WeWork](https://www.wework.com/?ref=review.firstround.com), as Director of Product Management. (Zhang also somehow manages to carve out time to deploy her product savvy in other arenas, as an [angel investor](https://angeltrack.firstround.com/meet-the-angels/jiaona-zhang?ref=review.firstround.com) and as a [lecturer at Stanford](http://scpd.stanford.edu/search/publicCourseSearchDetails.do?method=load&courseId=96273440&ref=review.firstround.com), where she teaches students embarking on the journey of early product-building.)
...
![](https://review.firstround.com/content/images/size/w600/2056/firstround/aqtvanysalieehhabeqk_burnt_pizza.jpg)
...
Shipping MLPs can bring powerful advantages for companies of all sizes. “If you’re at an early-stage startup, you need to be able to make the case for your users to stay while you [build-measure-learn](http://theleanstartup.com/principles?ref=review.firstround.com) on the way to strong product/market fit,” she says. “For larger companies, creating MLPs shows that you care about users enough to continue to invest in offerings and new product lines that remind them why they fell for your products in the first place."
...
She shares a lesson learned the hard way from Dropbox, to illustrate what happens when teams fail to understand what makes early products lovable. At the time, Zhang was leading the charge on [Project Harmony](https://techcrunch.com/2014/04/09/dropbox-launches-project-harmony-to-bring-collaborative-features-to-microsoft-office/?ref=review.firstround.com), which involved building a feature that signals users when someone else has opened the same document.
...
“When we first started building, we were satisfied with creating the ability to see if another collaborator was in the document. We thought that was good enough to ship,” she says. And while Project Harmony launched to [positive reception](https://venturebeat.com/2014/12/11/dropbox-launches-microsoft-office-collaboration-features-for-word-excel-and-powerpoint-on-windows-and-mac/?ref=review.firstround.com), in retrospect, Zhang believes that the product fell short of lovable.
...
To return to the example from Project Harmony, Zhang’s team had missed the “why” for the user. “The user ‘why’ wasn’t simply that they didn’t like conflicted copies. They wanted multiple collaborators to be able to work on the same document and make real-time changes. So when we tried to keep iterating on Project Harmony, we were only optimizing a local maximum,” says Zhang. “On the other hand, if we had more quickly invested those resources into building a more lovable product, like the technology that would become [Dropbox Paper](https://www.theverge.com/2017/1/30/14435582/dropbox-paper-business-app-launch-date-ios-android-web?ref=review.firstround.com) or [Spaces](https://techcrunch.com/2019/09/25/dropbox-will-start-rolling-out-the-new-dropbox-app-to-everyone-today/?ref=review.firstround.com), we would have worked toward a global maximum.”

![Aim for a global, not local, maximum when building early versions of your product.](https://review.firstround.com/content/images/size/w600/2056/firstround/gaxbeybhr2sraucmb2ep_local_vs_global_max.jpg)
...
![Problem vs. solution space](https://review.firstround.com/content/images/size/w600/2056/firstround/8o1oixyrrs2jwajyytsa_problem_vs_solution.jpg)
...
Finally, once students have focused on the problem space, identified the highest-value problem and chosen their game, they can open up what Zhang calls solution space ideation. "The entire approach, from start to finish, is similar to [design thinking](https://firstround.com/review/How-design-thinking-transformed-Airbnb-from-failing-startup-to-billion-dollar-business/?ref=review.firstround.com),” she says. “ **Diverge first to understand the problem space. Converge on the most important problem. Diverge again to come up with solutions. Converge on the solution that’s both usable *and* lovable**."
...
![Jiaona Zhang ("JZ"), Director of Product Management at WeWork.](https://assets.proof.pub/2056/firstround/TneLHnTFTsmeIhcpIrm8_JZ%20inline.jpg)
...
The same principles of prioritization apply for early-stage companies starting at square one. "If you've done your homework in the problem space, then you'll know what's most useful and valuable to the user. Start by designing your product around that most essential feature," she says. “Think of Dropbox: [it started off](https://firstround.com/review/how-dropbox-sources-scales-and-ships-its-best-product-ideas/?ref=review.firstround.com) as a solution to replace flash disks and thumb drives. Now, it offers an entire suite of collaboration products across consumer and enterprise markets.”
...
She shares a story from when she was at mobile gaming company [Pocket Gems](https://pocketgems.com/?ref=review.firstround.com)**.** Her team was working on a game called [Tap Paradise Cove](https://www.adweek.com/digital/pocket-gems-breaks-new-grounds-with-tap-paradise-cove/?ref=review.firstround.com) in 2011, at the height of popularity of games like Farmville. “The primary directive of Paradise Cove was to have players tap on a plot of land in order to ‘till’ it for crops,” she says.
...
To build on the intrigue that the fog sparked in players, Zhang and her team designed several narrative quests around the shrouded objects — and effectively made the user *mis* behavior a key part of the product.
...
![Pixie dust](https://review.firstround.com/content/images/size/w600/2056/firstround/trhgadrosr6zalfvupyw_pixie_dust.jpg)
...
Zhang’s taken notice of one company in particular that’s used pixie dust to help its products take flight. [As an angel investor](https://angeltrack.firstround.com/meet-the-angels/jiaona-zhang?ref=review.firstround.com), she backed mobile food ordering company [**Snackpass**](https://www.snackpass.co/?ref=review.firstround.com). Launched on Yale’s campus, Snackpass currently encompasses several major university campuses. “From the moment I started playing around with their product, I was struck by the pixie dust sprinkled all throughout the experience,” she says. “From the carefully-picked emoji in the copy, to a gifting feature with puns like ‘I love you a latte,’ the product showed incredible attention to their audience of students.”
...
![](https://review.firstround.com/content/images/size/w600/2056/firstround/clifsugkrdugpao7mmch_alpha_beta_ga.jpg)
...
*Illustrations courtesy of Jiaona Zhang. Photography by* [*Bonnie Rae Mills*](http://www.bonnieraemillsphoto.com/?ref=review.firstround.com)*.*

Share on:

Find more on The Review

Veteran product leader Jiaona Zhang walks us through the biggest lessons from her entire career in product at Dropbox, Airbnb, WeWork and now Webflow...

Tactical advice for weaving craft into your product and operationalizing taste.

Successful launches are fueled by robust beta programs. Here's how eero's Head of Beta & Special Programs Kelly Neary and Head of Product Paul...

In the first post for our new series, "Paths to Product-Market Fit," Airtable co-founder Andrew Ofstad sits down with First Round partner Todd Jackson...
...
To build the strongest teams from the get-go, PatientPing Co-founder and CEO Jay Desai has written the definitive user guide — on himself. Read on to...
