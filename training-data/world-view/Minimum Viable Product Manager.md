...
](https://medium.com/plans?source=upgrade_membership---post_top_nav_upsell-----------------------------------------)## [The Startup](https://medium.com/swlh?source=post_page---publication_nav-f5af2b715248-852e744f041d---------------------------------------)

[![The Startup](https://miro.medium.com/v2/resize:fill:76:76/1*pKOfOAOvx-fWzfITATgGRg.jpeg)](https://medium.com/swlh?source=post_page---post_publication_sidebar-f5af2b715248-852e744f041d---------------------------------------)

Get smarter at building your thing. Follow to join The Startup’s +8 million monthly readers & +772K followers.

Despite a recent explosion in paid courses to develop product management talent such as [General Assembly](https://generalassemb.ly/education/product-management/london), [Product School](https://www.productschool.com/) and [Knowledge Officer](https://knowledgeofficer.com/career-paths/product-manager), the main way product managers are brought up is through on-the-job experience.
...
Some companies, particularly those following some version of SAFe ([Scaled Agile Framework](https://en.wikipedia.org/wiki/Scaled_agile_framework)), tackle the problem by creating a product owner role in which the responsibility is cut horizontally. Other companies might call this a business owner or commercial owner. I’ll use product owner.
...
The business needs the right problems, which are aligned to the vision and strategy, to be solved in the right way, that is [feasible, usable and valuable](https://svpg.com/four-big-risks/). When the responsibilities are split horizontally however:
...
Much like what was proposed by

[Jussi Pasanen](https://medium.com/u/91a7501a949f?source=post_page---user_mention--852e744f041d---------------------------------------)

when he first introduced his model of Minimum Viable Product, cutting across all layers of what a product should be, the Minimum Viable Product Manager needs to cut across all the layers of what a product manager should be.

![MVP is cutting one slice across emotional design, usable, reliable and functional, rather than all the functional components.](https://miro.medium.com/v2/resize:fit:640/format:webp/1*Xd8PB647pMWTGz7VVCAUrA.png)

“Minimum Viable Product: Build a slice across, instead of one layer at a time.” — Jussi Pasanen
...
![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*UrWaEMAeoopHi_o0HKIE8g.png)

Minimum Viable Product Manager: all layers, just in smaller, less risky quantities.
...
![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*Okn_AKwYpRr8UL7TevdQlA.png)

The first year of an associate product manager: a controlled crescendo of increased responsibility building up to full minimum viable product manager.
...
![PM career ladder: from feature, small product, larger product, multiple products, line of business to whole company](https://miro.medium.com/v2/resize:fit:640/format:webp/1*4NXuzYMg9GFSTLJG4Zo2-g.png)

Product Management Career Ladder.

The shape of the associate product manager slice in the pyramid is deliberate. Its base is wider than the top. An associate product manager will spend most of their time on tactical activities related to the lowest levels of the pyramid. They should also be involved in operations, strategy and vision setting, even if making smaller contributions.

[Melissa Perri](https://medium.com/u/d5387b79efe8?source=post_page---user_mention--852e744f041d---------------------------------------)

contextualises this with the makeup of other product management roles:

![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*jsLKX8QDEX_ytUwWT0Nmjw.png)

Strategic, operational and tactical percentages of product roles by Melissa Perri in Escaping the Build Trap
...
*PS: I’ve given a talk which explores the product management career ladder, emotional resilience and product failure at* [*Jam*](https://www.makingjam.io/) *London in 2019. You can* [*watch it here*](https://www.youtube.com/watch?v=69Tb_4-zyhM)*.*

[![The Startup](https://miro.medium.com/v2/resize:fill:96:96/1*pKOfOAOvx-fWzfITATgGRg.jpeg)](https://medium.com/swlh?source=post_page---post_publication_info--852e744f041d---------------------------------------)

[![The Startup](https://miro.medium.com/v2/resize:fill:128:128/1*pKOfOAOvx-fWzfITATgGRg.jpeg)](https://medium.com/swlh?source=post_page---post_publication_info--852e744f041d---------------------------------------)

[Last published 7 hours ago](https://medium.com/swlh/just-tell-me-the-price-already-caaf3b7d6f6c?source=post_page---post_publication_info--852e744f041d---------------------------------------)
...
15[2](https://nyseans.medium.com/interesting-and-thought-provoking-article-around-the-minimum-viable-product-manager-973d40b97f79?source=post_page---post_responses--852e744f041d---------------------------------------)

[

Interesting and thought-provoking article around the Minimum Viable Product Manager. In essence, it proposes that the most effective manner for an organization to deliver customer value, business value, and value to the employees is through a vertically integrated career progression.

](https://nyseans.medium.com/interesting-and-thought-provoking-article-around-the-minimum-viable-product-manager-973d40b97f79?source=post_page---post_responses--852e744f041d---------------------------------------)
