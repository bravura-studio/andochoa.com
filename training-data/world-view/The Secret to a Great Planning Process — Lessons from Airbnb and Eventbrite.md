...
![The Secret to a Great Planning Process — Lessons from Airbnb and Eventbrite](https://review.firstround.com/content/images/size/w320/format/webp/2056/firstround/rgqsfno4tnsmu3kwgzs7_lenny-20nels-20hero.jpg)

The Secret to a Great Planning Process — Lessons from Airbnb and Eventbrite

*This article is by* [*Lenny Rachitsky*](https://twitter.com/lennysan?ref=review.firstround.com)*, a former product lead and head of consumer supply growth at Airbnb, and* [*Nels Gilbreth*](https://www.linkedin.com/in/nels-gilbreth-36a9821/?ref=review.firstround.com)*, former Head of Global Revenue Strategy at Eventbrite.*
...
![](https://assets.proof.pub/2056/firstround/O6rbG1rNQ2emg8EPj1Xa_TKImage%200%20Leadership%20Frames.png)
...
*“The first liberating change managers can make to improve the quality of the planning process is to begin it by deliberately and thoughtfully identifying and discussing the strategic issues that will have the greatest impact on future business performance."* — [*McKinsey*](https://www.mckinsey.com/business-functions/strategy-and-corporate-finance/our-insights/how-to-improve-strategic-planning?ref=review.firstround.com)
...
![](https://assets.proof.pub/2056/firstround/zZwPLEJSQ8e2k6CMBl97_Image%201%20Company%20Strategy.jpg)
...
In parallel, consider the idea of reorganizing your teams to align with your strategy. This may sound painful now, but in our experience, having your strategy inform your structure (versus the other way around) is the only way to be successful long-term. As an example, when Airbnb expanded into the [Experiences](https://www.airbnb.com/s/experiences?ref=review.firstround.com), they could have tasked the existing teams with working together to create this new line of business. Instead the leaders made the right call to create a brand new team that would work relatively independently and report directly into an executive. [Coinbase went through the same learnings](https://firstround.com/review/lessons-from-coinbases-wild-ascent-four-rules-for-scaling/?ref=review.firstround.com), recognizing they should shape their org chart to mold to the product, not the other way around.
...
![](https://assets.proof.pub/2056/firstround/fxmCWSi7QO2cVJfZL6QM_Image%202%20Key%20Initiative%20Strategy.jpg)
...
![](https://assets.proof.pub/2056/firstround/9yD7VUhcQCm5qXsyk0QF_Image%203%20Planning%20timeline%20template.png)
...
- **4\. Ideate:** For each of the hypotheses, come up with ideas for testing and addressing these hypotheses. [Here are a number of ways to come up with good ideas](https://www.lennyrachitsky.com/p/where-great-product-roadmap-ideas?ref=review.firstround.com).
- **5\. Create a strawman plan:** Similar to Step One, one person (ideally the team lead) should take a first pass at developing the [team plan](https://docs.google.com/document/d/1RQWuvWDgcAv1ylksFXtiwhuTbHLcL1byIcoXsbCQfic/edit?ref=review.firstround.com#).
...
![Nels Gilbreth](https://assets.proof.pub/2056/firstround/T9tTQtwQQcyOMIBjlP69_Nels%20headshot.jpeg)
...
## You can continue to use to collect the final integrated plan.
...
- **Doing too much:** Leadership says yes to too many things. Avoid spreading your resources like [peanut butter](https://www.mckinsey.com/business-functions/strategy-and-corporate-finance/our-insights/the-strategy-and-corporate-finance-blog/why-your-business-needs-a-hit-mentality?ref=review.firstround.com). Do the hard things now. Some people will be upset because things are cut. Remind them how essential it is to get the higher priorities done right.
...
![Lenny Rachitsky](https://review.firstround.com/content/images/size/w600/2056/firstround/rxyqzflatkkhemdtzo4l_lenny-rachitsky_098rt.jpg)
...
**Step 1: Leadership provides context with Teams** *Goal*: Leadership delivers its perspective on what’s most important *Deliverable*: [Draft Strategic Plan](https://docs.google.com/document/d/1JI73WrGplrhNE46aLyRD_B74gEynI77EPgXn1ic6WeQ/edit?ref=review.firstround.com#), which should include:
...
**Step 2: Teams respond with a proposed plan** *Goal*: The Teams assemble their proposed plans for the year ahead *Deliverables*: [A plan for each Key Initiative](https://docs.google.com/document/d/1RQWuvWDgcAv1ylksFXtiwhuTbHLcL1byIcoXsbCQfic/edit?ref=review.firstround.com#heading=h.c50sltibqqhp), which should include:
...
**Step 3: Leadership shares an integrated plan** *Goals*: Leadership integrates the many different plans into one company plan *Deliverables*: A cohesive [company plan](https://docs.google.com/document/d/1JI73WrGplrhNE46aLyRD_B74gEynI77EPgXn1ic6WeQ/edit?ref=review.firstround.com#), which should include:
...
*Thank you* [*Vanessa Schneider*](https://www.linkedin.com/in/vanessahopeschneider/?ref=review.firstround.com), [*Isabel Tewes*](https://www.linkedin.com/in/isabeltewes/?ref=review.firstround.com)*, and* [*Laura Chambers*](https://www.linkedin.com/in/chamberslaura/?ref=review.firstround.com) *for reviewing early drafts of this post.*

*Image by Getty Images / Sally Elford. Photo of Lenny Rachitsky by* [*Bonnie Rae Mills.*](http://www.bonnieraemillsphoto.com/?ref=review.firstround.com)

Share on:

Find more on The Review

We’ve combed the extensive Review archives for a timely roundup of the most unique advice for end-of-year strategic planning. Leaders like Lenny...

Seasoned product leader and Slack’s CPO Noah Desai Weiss shares the three-step framework he leans on to make quality product decisions with just the...

Ravi Mehta, former CPO at Tinder & Product Exec at TripAdvisor, shares his framework for crafting a crisp product strategy for startups — a 5-step...

Engineering leader Varun Srinivasan had a front-row seat as Coinbase scaled to meet an explosion in demand for cryptocurrencies. Here, he shares the...
...
Sharp folks from across the First Round community share the small habits that great managers do, including delivering feedback with care, opening up...
