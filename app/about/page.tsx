  ...
  return (
    ...
    >
      <article className="mx-auto max-w-[760px] space-y-8">
        {/* Fix 2: colour profile pic | Fix 3: bio = 3 sentences */}
        ...
        {/* Fix 9: Mantra hero block — three-column BUILD·FUN·FREE */}
        ...
        {/* Fix 5+6: Experience section card + visual timeline */}
        ...
        {/* Fix 5+7: Skills section card + pill tag styling matching posts badges */}
        ...
        {/* Fix 8: Contact — prominent CTAs + social icon pills */}
